  ...
  try {
    ...
    await client.query(
      ...
      [
        ...
        'Standard delivery within Malaysia is typically 2-5 business days after dispatch. Orders are processed on business days. Delivery times may vary during campaigns, public holidays, or for East Malaysia. Tracking details are provided when available.',
        'Returns are accepted within 14 days of delivery for eligible unused items in their original condition and packaging. Proof of purchase is required. Final-sale, hygiene-sensitive, and personalised items may be excluded. Approved refunds are returned to the original payment method.',
